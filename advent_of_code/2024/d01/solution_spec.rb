...
RSpec.describe 'Solutions' do
    ...
    describe 'final result for pt1' do
      context 'with example input data' do
        it 'returns correct result' do
          expect(Solution.new(example_input).solution_pt1).to eq 11
        end
      end
      ...
      context 'with custom input data' do
        it 'returns correct result' do
          ...
          expect(Solution.new(custom_input).solution_pt1).to eq 3_714_264
        end
      end
    end
  end
  ...
  describe 'Part 2' do
    ...
    context 'with example input data' do
      it 'returns correct result' do
        expect(Solution.new(example_input).solution_pt2).to eq 31
      end
    end
